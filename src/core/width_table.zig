//! Generated by tools/gen_width_table.py -- do not edit by hand.
//! Unicode 16.0.0, East_Asian_Width in {Wide, Fullwidth}.

pub const Range = struct { lo: u21, hi: u21 };

/// Code points that occupy two monospace cells. Sorted by `lo`.
